...
class SignalNoiseKnobLookAndFeel : public juce::LookAndFeel_V4
{
public:
	// Constructor
	explicit SignalNoiseKnobLookAndFeel(const juce::Image& filmstripImage);

	// Optional: default constructor if you want to assign image later
	SignalNoiseKnobLookAndFeel() = default;
